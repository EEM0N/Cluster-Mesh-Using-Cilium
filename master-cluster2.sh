...
# === CONFIGURATION ===
MASTER_IP="192.168.56.20"             # IP of this master node
NODENAME=$(hostname -s)
POD_CIDR="10.43.0.0/16"               # Must be unique per cluster
SRV_CIDR="10.130.0.0/16"              # Optional: service CIDR
CLUSTER_NAME="cluster-2"              # Unique per cluster
CLUSTER_ID=2                          # Must be unique per cluster
KVSTORE="etcd://192.168.56.20:2379"   # IP of your etcd VM/node (must be accessible from all clusters)
K8S_API_SERVER_IP="192.168.56.20"
